...
<head>
   <meta charset="UTF-8">
    ...
    <meta name="keywords" content=" Gaming Landing, Page, SEO" />
    <meta name="description" content="Zenith Pixels - Gaming Landing" />
    <title>Zenith Pixels - Games</title>
...
<body id="darkmode" class="inner-page">
    <!-- Preloader -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class='main-btn model-btn' href='cart.html'>Checkout $320</a>
                </div>
            </div>
        </div>
    </div> -->
    ...
    <!-- Billing Modal -->
    <!-- <div class="modal fade" id="billing-model-large" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h5 class="modal-title">Billing Details <b>.</b></h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="main-btn model-btn">Payment $298</button>
                    </div>
                </form>
            </div>
        </div>
  ...
  <!-- HEADER AREA START -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top" id="navber">
        <div class="container">
            <a class='navbar-brand' href='index.html'>ZENITH PIXELS<span>.</span></a>
        ...
        <div class="custom-menubar">
            <ul class="nav-link-block">
                ...
                <li>
                    <a href="#game" class="menu-link">Our Games</a>
                </li>
                <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3>Our Games</h3>
                    <a href='index.html'><i class="fa fa-home" aria-hidden="true"></i> Home</a><span> - Our Games</span>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                      <div class="col-lg-3 col-sm-6 text-center">
                            <div class="product-item">
                                <!-- <h3>$240</h3> -->
                                <img src="images/game1.jpg" alt="product-img" class="img-fluid">
                                <h4>Double Dragon</h4>
                                <div class="star">
                                ...
                                <a href="#" class="product-btn">Download<i class="fa fa-download" aria-hidden="true"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 text-center">
                            <div class="product-item">
                                <!-- <h3>$240</h3> -->
                                <img src="images/game3.jpg" alt="product-img" class="img-fluid">
                                <h4>Double Dragon</h4>
                                <div class="star">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                            ...
                            <div class="product-item">
                                <!-- <h3>$240</h3> -->
                                <img src="images/game2.jpg" alt="product-img" class="img-fluid">
                                <h4>Double Dragon</h4>
                                <div class="star">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                            ...
                            <div class="product-item">
                                <!-- <h3>$240</h3> -->
                                <img src="images/game4.jpg" alt="product-img" class="img-fluid">
                                <h4>Double Dragon</h4>
                                <div class="star">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 footer-logo">
                    <a href='index.html'>ZENITH PIXELS<b>.</b></a>
 ...
 <nav class="navbar  footer_menu_top" >
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6 col-sm-7 copy-right-txt">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i> 2026 - Developed by <a href="index.html">Zenith Pixels<b>.</b></a></p>
                        </div>
